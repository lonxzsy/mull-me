...
import { Copy, RefreshCw, Trash2, Clock, Shield, Zap, Mail, Clock12 } from 'lucide-react'
  ...
  return (
    <div className="card space-y-6">
      ...
      {address ? (
        ...
        <div className="flex flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-border bg-surface/50 py-10 text-center">
